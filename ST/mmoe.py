...
class MMOE(nn.Module):
    ...
    def forward(self, x):
        ...
        print(f'expert_out: {experts_out.shape}')
...
if __name__ == "__main__":
    ...
    mmoe = MMOE(user_cate_dict, item_cate_dict, n_expert=18)
    outs = mmoe(a)
    # print(outs)
    model_parameters = filter(lambda p: p.requires_grad, mmoe.parameters())
