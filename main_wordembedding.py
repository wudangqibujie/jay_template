from word_embedding.word2vec.input_data import InputData
import numpy
from word_embedding.word2vec.model import SkipGramModel
...
if __name__ == '__main__':
    w2v = Word2Vec(input_file_name='word_embedding/word2vec/zhihu.txt', output_file_name='word_embedding.txt')
    w2v.train()
